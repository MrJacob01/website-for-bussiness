            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="rs-banner-item-wrapper">
                        <div class="rs-banner-bg-thumb" data-background="{{ asset('images/bg/banner-bg-16.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-8 col-xl-9 col-lg-10">
                                    <div class="rs-banner-item">
                                        <div class="rs-banner-content">
                                            ...
                                            <h1 class="rs-banner-title">The automation of our world offers tremendous
                                                benefits
                                            </h1>
                                            <div class="rs-banner-descrip">
                                                <p>At the heart of the global landscape, standard dummy text ever since the
                                                    1500s, when an unknown printer the industry.</p>
                                            </div>
                                            <div class="rs-banner-info-btn">
                                                <div class="rs-banner-btn">
                                                    <a class="rs-btn has-theme-orange has-icon has-bg has-large-radius" href="contact.html">Explore More
                                                        <span class="icon-box">
                                           ...
                                           <svg class="icon-second" xmlns="http://www.w3.org/2000/svg"
                                              ...
                                              <path
                                                ...
                                                <div class="rs-feature-video">
                                                    <a href="https://www.youtube.com/watch?v=QURYUgzssnY" class="rs-play-btn popup-video"><i class="ri-play-fill"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="swiper-slide">
                    <div class="rs-banner-item-wrapper">
                        <div class="rs-banner-bg-thumb" data-background="{{ asset('images/bg/banner-bg-17.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xxl-8 col-xl-9 col-lg-10">
                                    <div class="rs-banner-item">
                                        <div class="rs-banner-content">
                                            <h1 class="rs-banner-title">The robotization of our world is an great advantage
                                            </h1>
                                            <div class="rs-banner-descrip">
                                                <p>At the heart of the global landscape, standard dummy text ever since the
                                                    1500s, when an unknown printer the industry.</p>
...
<section class="rs-about-area section-space rs-about-ten">
    <div class="rs-about-shape-two">
        <img src="{{ asset('images/shape/robo-arm-03.png') }}" alt="image">
    </div>
    <div class="container">
        <div class="row g-5">
            <div class="col-12">
                <div class="rs-about-wrapper">
                    <div class="rs-about-thumb-wrapper">
                        <div class="rs-about-shape-one prallax-parent">
                            <img data-depth="1.3" src="{{ asset('images/shape/dott-shape.png') }}" alt="image">
                        </div>
                        <div class="rs-about-thumb">
                            <img src="{{ asset('images/about/about-thumb-13.png') }}" alt="image">
                        </div>
                    ...
                    <div class="rs-about-content-wrapper">
                      ...
                      About Industrie
                         ...
                         class="rs-theme-orange">since 1989</span>. Industrial around the world</h2>
        ...
        <div class="row  g-5 justify-content-center section-title-space align-items-center">
            <div class="col-xl-9 col-lg-10">
                ...
                What We Do For You
                    ...
                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Our Institution's <span
                   class="rs-theme-orange">Daily</span> News</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="rs-services-slider-wrapper">
                    <div class="swiper" data-clone-slides="false" data-loop="false" data-speed="2000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="1000" data-item="3" data-item-xl="2" data-item-lg="2" data-item-md="2" data-item-sm="1" data-item-xs="1" data-item-mobile="1" data-margin="30">
                        ...
                        @foreach($dailyNews->contents as $content)
                            <div class="swiper-slide">
                                <div class="rs-services-item">
                                    <div class="rs-services-thumb">
                                        {{-- You can add an image if you have image field --}}
                                        <img src="{{ $content->path ?? asset('images\gallery\gallery-thumb-01.png') }}" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        ...
                                        <div class="rs-services-descrip">
                                            <p>{{ Str::limit(strip_tags($content->text), 150) }}</p> {{-- limit text to 150 characters --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <!-- <div class="swiper-slide">
                                <div class="rs-services-item">
                                    <div class="rs-services-thumb">
                                        <img src="{{ asset('images/services/services-thumb-25.png') }}" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        <h5 class="rs-services-title"><a href="services-details.html"> Best innovations </a>
                                        </h5>
                                        <div class="rs-services-descrip">
                            ...
                            <div class="swiper-slide">
                                <div class="rs-services-item">
                                    <div class="rs-services-thumb">
                                        <img src="{{ asset('images/services/services-thumb-26.png') }}" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        <h5 class="rs-services-title"><a href="services-details.html"> IOT Integration </a>
                                        </h5>
                                        <div class="rs-services-descrip">
                            ...
                            <div class="swiper-slide">
                                <div class="rs-services-item">
                                    <div class="rs-services-thumb">
                                        <img src="{{ asset('images/services/services-thumb-24.png') }}" alt="image">
                                    </div>
                                    <div class="rs-services-content">
                                        <h5 class="rs-services-title"><a href="services-details.html"> Robot Installation
                                            </a></h5>
                                        <div class="rs-services-descrip">
                                            <p>Stands as a multidimensional force of progress driving.</p>
                                        </div>
...
<section class="rs-why-choose-area rs-why-choose-three">
    ...
    <div class="rs-why-choose-bg-thumb" data-background="{{ asset('images/bg/why-choose-bg.png') }}"></div>
    <div class="container">
        <div class="row">
                        ...
                        <div class="rs-why-choose-content-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-why-choose-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="39" viewBox="0 0 52 39" fill="none">
                                    ...
                                    <path d="M18.4194 35.0323H1V1H51V35.0323H33.5806" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M4.22656 4.22461C5.75882 4.22461 5.75882 5.273 7.37172 5.273C8.90398 5.273 8.90398 4.22461 10.5169 4.22461C12.0491 4.22461 12.0491 5.273 13.662 5.273C15.1943 5.273 15.1943 4.22461 16.8072 4.22461C18.3395 4.22461 18.3395 5.273 19.9524 5.273C21.4846 5.273 21.4846 4.22461 23.0975 4.22461C24.6298 4.22461 24.6298 5.273 26.2427 5.273C27.7749 5.273 27.7749 4.22461 29.3879 4.22461C30.9201 4.22461 30.9201 5.273 32.533 5.273C34.0653 5.273 34.0653 4.22461 35.6782 4.22461C37.2104 4.22461 37.2104 5.273 38.8233 5.273C40.4362 5.273 40.3556 4.22461 41.9685 4.22461C43.5008 4.22461 43.5008 5.273 45.1137 5.273C46.6459 5.273 46.6459 4.22461 48.2588 4.22461" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M4.22656 4.22461C4.22656 5.91816 5.27495 5.91816 5.27495 7.69235C5.27495 9.3859 4.22656 9.3859 4.22656 11.1601C4.22656 12.8536 5.27495 12.8536 5.27495 14.6278C5.27495 16.3214 4.22656 16.3214 4.22656 18.0149C4.22656 19.7085 5.27495 19.7085 5.27495 21.4827C5.27495 23.1762 4.22656 23.1762 4.22656 24.9504C4.22656 26.644 5.27495 26.644 5.27495 28.4182C5.27495 30.1117 4.22656 30.1117 4.22656 31.8859" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M33.582 31.1613C34.0659 31.4839 34.3885 31.8064 35.2756 31.8064C36.8078 31.8064 36.8078 30.7581 38.4207 30.7581C40.0336 30.7581 39.953 31.8064 41.5659 31.8064C43.1788 31.8064 43.0982 30.7581 44.7111 30.7581C46.2433 30.7581 46.2433 31.8064 47.8562 31.8064" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M4.22656 31.8062C5.75882 31.8062 5.75882 30.7578 7.37172 30.7578C8.98463 30.7578 8.90398 31.8062 10.5169 31.8062C12.1298 31.8062 12.0491 30.7578 13.662 30.7578C15.275 30.7578 15.1943 31.8062 16.8072 31.8062C17.6943 31.8062 18.0975 31.4836 18.5008 31.161" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M10.2754 9.95117H41.727" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M41.7259 12.8535H32.3711" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M19.6302 12.8535H10.2754" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M39.0663 15.8379H35.1953" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M16.8065 15.8379H12.9355" stroke="white" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
    ...
    <div class="rs-why-choose-btn-wrapper" data-background="{{ asset('images/bg/video-bg-05.png') }}">
...
<section class="rs-portfolio-area section-space rs-portfolio-seven rs-swiper">
    <div class="rs-portfolio-shape">
        <img src="{{ asset('images/shape/robo-arm-01.png') }}" alt="image">
    </div>
    <div class="rs-portfolio-shape-two has-reverse">
        <img class="gsap-rotate-anti" src="{{ asset('images/shape/gear-shape-01.png') }}" alt="">
    </div>
    <div class="rs-portfolio-shape-three">
        <img class="gsap-rotate" src="{{ asset('images/shape/gear-shape-02.png') }}" alt="">
    </div>
    <div class="container">
        <div class="row  g-5 justify-content-center section-title-space align-items-center">
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-8 col-sm-10">
                ...
                Recent Project
                    ...
                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Gallery our company's complete
        ...
        <div class="row">
            <div class="col-12">
                <div class="rs-portfolio-slider-wrapper">
                    <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="1000" data-item="3" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-item-mobile="1" data-margin="30">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="{{ asset('images/portfolio/portfolio-thumb-29.png') }}" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <div class="rs-portfolio-tag">
                                            <a href="portfolio-details.html">Robotic</a>
                                        </div>
                                        <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Metal Engineering
                                            </a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="{{ asset('images/portfolio/portfolio-thumb-30.png') }}" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <div class="rs-portfolio-tag">
                                            <a href="portfolio-details.html">Robotic</a>
                                        </div>
                                        <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Factory Conveyors
                                            </a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="{{ asset('images/portfolio/portfolio-thumb-31.png') }}" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <div class="rs-portfolio-tag">
                                            <a href="portfolio-details.html">Robotic</a>
                                        </div>
                                        <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Robotics Industry
                                            </a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="{{ asset('images/portfolio/portfolio-thumb-28.png') }}" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <div class="rs-portfolio-tag">
                                            <a href="portfolio-details.html">Robotic</a>
                                        </div>
                                        <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Oil &amp; Gas
                                                Factory
                                            </a></h5>
                                    </div>
                                </div>
...
<div class="rs-counter-area rs-counter-one section-space-bottom p-relative">
    <div class="rs-counter-shape">
        <img src="{{ asset('images/shape/robot-shape-01.png') }}" alt="">
    </div>
    <div class="container">
        <div class="row g-5">
        ...
        <div class="row  g-5 justify-content-center section-title-space align-items-center">
            <div class="col-xxl-8 col-xl-10 col-lg-10">
                ...
                Our Team Member
                    ...
                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">We will serve you with the best of
        ...
        <div class="row g-5">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rs-team-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                    <div class="rs-team-thumb">
                        <img src="{{ asset('images/team/team-thumb-06.png') }}" alt="image">
                    </div>
                    <div class="rs-team-content">
                        <div class="rs-team-inner">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rs-team-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                    <div class="rs-team-thumb">
                        <img src="{{ asset('images/team/team-thumb-07.png') }}" alt="image">
                    </div>
                    <div class="rs-team-content">
                        <div class="rs-team-inner">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rs-team-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                    <div class="rs-team-thumb">
                        <img src="{{ asset('images/team/team-thumb-08.png') }}" alt="image">
                    </div>
                    <div class="rs-team-content">
                        <div class="rs-team-inner">
...
<section class="rs-work-process-area section-space rs-work-step-two has-theme-orange">
    <div class="rs-work-step-shape gsap-move right-110 start-71">
        <img src="{{ asset('images/shape/robo-arm-02.png') }}" alt="image">
    </div>
    <div class="rs-work-step-bg-thumb" data-background="{{ asset('images/bg/contact-bg-06.png') }}"></div>
    <div class="container">
        <div class="row align-items-center g-5">
                        ...
                        <div class="rs-work-step-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-work-step-number">
                                ...
                                <div class="rs-work-step-thumb">
                                    <img src="{{ asset('images/shape/work-process-shape-gray.svg') }}" alt="">
                                </div>
                                <div class="rs-work-step-thumb has-orange">
                                    <img src="{{ asset('images/shape/work-process-shape-orange.svg') }}" alt="">
                                </div>
                            </div>
            ...
            <div class="col-xl-5 col-lg-5">
                <div class="rs-contact-form rs-contact-one has-robotic wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="rs-contact-bg-thumb" data-background="{{ asset('images/bg/contact-bg-07.png') }}">
                    </div>
                    ...
                    <form id="contact-form" action="https://industrie.rstheme.com/html/{{ asset('mailer.php') }}" method="POST">
                        <div class="row g-4">
                            <div class="col-md-12">
...
<section class="rs-blog-area section-space rs-blog-four">
    <div class="rs-blog-bg-thumb" data-background="{{ asset('images/blog/blog-bg-01.png') }}">
        ...
        <div class="row  g-5 justify-content-center section-title-space align-items-center">
            <div class="col-xl-8 col-lg-9 col-md-10">
                ...
                News &amp; Blog
                    ...
                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Discover the future of factories
                        and <span class="rs-theme-orange">industries</span></h2>
                </div>
            </div>
        </div>
        <div class="row g-5">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="rs-blog-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="rs-blog-thumb">
                        <img src="{{ asset('images/blog/blog-thumb-16.png') }}" alt="image">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="rs-blog-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                    <div class="rs-blog-thumb">
                        <img src="{{ asset('images/blog/blog-thumb-17.png') }}" alt="image">
                        <div class="rs-blog-tag">
                            <a href="blog-details.html">Robotics</a>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="rs-blog-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                    <div class="rs-blog-thumb">
                        <img src="{{ asset('images/blog/blog-thumb-18.png') }}" alt="image">
                        <div class="rs-blog-tag">
                            <a href="blog-details.html">Robotics</a>
                        </div>
                    </div>
                    <div class="rs-blog-content">
                        <div class="rs-blog-inner">
                            <h5 class="rs-blog-title underline has-black"> <a href="blog-details.html">Building resilient
                                    supply for industries and factorie</a></h5>
                            <div class="rs-blog-meta">
                                <div class="rs-blog-meta-item">
                                    <span>
                            By
                            ...
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    ...
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-02.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    <span class="rs-brand-shape"></span>
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-03.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    <span class="rs-brand-shape"></span>
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-04.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    <span class="rs-brand-shape"></span>
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-05.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    <span class="rs-brand-shape"></span>
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-06.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="rs-brand-item">
                                    <span class="rs-brand-shape"></span>
                                    <div class="rs-brand-thumb">
                                        <img src="{{ asset('images/brand/brand-thumb-07.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
